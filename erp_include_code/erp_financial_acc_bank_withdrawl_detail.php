...
<h2> By Date Financial Account Bank Withdrawl Detail </h2>
  <form name="form1" method="post" action="">
    <table width="200" border="1">
      <tr>
        <td><strong>Withdrawal Name</strong></td>
        <td><strong><?php echo $row_RS_FinancialAccWithdrawl['WithdrawalByName']; ?></strong></td>
      </tr>
      <tr>
