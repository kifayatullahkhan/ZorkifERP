...
$query_RS_ByYearEmpSalary = "SELECT erp_employee_salary.SalaryYear FROM erp_employee_salary GROUP BY erp_employee_salary.SalaryYear";
...
?>
<div class="1">
<h2>ByYear Employee Salary Detail</h2>
  <form name="form1" method="post" action="erp_byyear_emp_salary_detail.php">
    <table border="1">
      <tr>
        <th>SalaryYear</th>
        <th>&nbsp;</th>
