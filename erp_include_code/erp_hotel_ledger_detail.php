...
?>
<div class="1">
<h2>Hotel Client Ledger Detail</h2>
...
<div class="1">
  <form name="form2" method="post" action="">
    <table border="1">
      ...
      <?php $Credit=0; $H_Debit=0; $H_Credit=0; do { ?>
        <tr>
        ...
        <?php $H_Debit=$H_Debit+$row_RS_HotelClient['TotalAmountPaid'];?>
        <?php $H_Credit=$H_Credit+$Credit['Credit'];?>
        <?php } while ($row_RS_HotelClient = mysql_fetch_assoc($RS_HotelClient)); ?>
         <tr>
          ...
          <td><strong>Dr : <?php echo $H_Debit; ?></strong></td>
          <td><strong>Cr : <?php echo $H_Credit; ?></strong></td>
        </tr>
    </table>
  </form>
</div>
