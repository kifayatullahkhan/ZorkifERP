  ...
  <form id="form1" name="form1" method="post" action="">
    <table width="200" border="1">
      ...
      <tr>
        ...
        <td><strong><?php echo $row_RS_ByDatePurchase['OrderStatus']; ?></strong></td>
      </tr>
      <tr>
...
<div class="1">
  <form id="form2" name="form2" method="post" action="">
    <table border="1">
      <tr>
        <th>OrderDate</th>
        <th>OrderReferenceNo</td>
        <th>SupplierName</td>
        <th>PItemDescription</td>
        <th>Quantity</th>
      ...
      <?php $Credit=0; $S_Debit=0; $S_Credit=0; do { ?>
        <tr>
          <td><?php echo $row_RS_ByDatePurchase['OrderDate']; ?></td>
          <td><?php echo $row_RS_ByDatePurchase['OrderReferenceNo']; ?></td>
          <td><?php echo $row_RS_ByDatePurchase['SupplierName']; ?></td>
          <td><?php echo $row_RS_ByDatePurchase['PItemDescription']; ?></td>
          <td><?php echo $row_RS_ByDatePurchase['Quantity']; ?></td>
          <td><?php echo $row_RS_ByDatePurchase['Price_Per_Unit']; ?></td>
          <td><?php echo $row_RS_ByDatePurchase['PurchaseTotal']; ?></td>
          <td><?php echo $row_RS_ByDatePurchase['OtherExpenses']; ?></td>
          <td><?php echo $row_RS_ByDatePurchase['Debit']; ?></td>
          <td><?php echo $Credit['Credit']; ?></td>
        </tr>
        <?php $S_Debit=$S_Debit+$row_RS_ByDatePurchase['Debit'];?>
        <?php $S_Credit=$S_Credit+$Credit['Credit'];?>
        <?php } while ($row_RS_ByDatePurchase = mysql_fetch_assoc($RS_ByDatePurchase)); ?>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
...
<?php
mysql_free_result($RS_ByDatePurchase);
?>
