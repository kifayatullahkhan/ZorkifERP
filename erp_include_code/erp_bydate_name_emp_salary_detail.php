...
$query_RS_EmpSalary = "SELECT erp_employee_details.EmployeeName, erp_employee_salary.SalaryMonth, erp_employee_salary.SalaryYear, erp_employee_details.EmploymentDate, erp_employee_salary.PaymentStatus, erp_employee_details.Commession , erp_employee_salary.BasicSalaryAmount, erp_employee_salary.BonusSalaryAmount, erp_employee_salary.OverTimeSalaryAmount,  erp_employee_salary.DeductionFromSalaryAmount, erp_employee_salary.TaxRate, erp_employee_salary.NetPaySalaryAmount  FROM erp_employee_salary  JOIN  erp_employee_details ON erp_employee_salary.EmployeeID = '$Emp_name' WHERE erp_employee_salary.PaymentStatus = 'DONE' AND erp_employee_salary.SalaryYear = '$Year' AND erp_employee_salary.EmployeeID = '$Emp_name' AND erp_employee_salary.SalaryMonth = '$Month' GROUP BY erp_employee_salary.SalaryMonth";
